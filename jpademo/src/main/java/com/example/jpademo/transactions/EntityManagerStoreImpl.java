 ...
 * The {@link com.example.jpademo.transactions.TransactionInterceptor} is expected to register entity manager. The application code
...
public class EntityManagerStoreImpl implements EntityManagerStore {
    ...
    private static final Logger logger = LoggerFactory.getLogger(EntityManagerStoreImpl.class);
